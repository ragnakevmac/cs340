...
SELECT d1.commuter_pass_id AS "Commuter Pass ID", d1.cost AS "Cost Paid", d1.start_date AS "Start Date", d1.end_date AS "End Date", d3.trainline_company AS "Trainline Access", 
...
SELECT prefecture_id AS "Prefecture ID", prefecture_name AS "Prefecture Name" from Prefectures;
